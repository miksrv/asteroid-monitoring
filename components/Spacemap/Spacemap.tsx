...
export const Spacemap: React.FC<AsteroidProps> = ({ asteroidName, orbitalData }) => {
    ...
    useEffect(() => {
        ...
        const viz = new Spacekit.Simulation(container as unknown as HTMLCanvasElement, {
        ...
        return () => {
            // spacekit.js@0.1.1 has no public destroy() — clear the DOM to release the WebGL context
            container.innerHTML = ''
        }
    }, [orbitalData])
